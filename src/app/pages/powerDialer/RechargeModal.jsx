...
const RechargeModal = ({ isOpen, onClose }) => {
  ...
  // Helper function to avoid rounding issues (similar to CartSidebar)
  ...
  // Calculate commission (3% of recharged amount)
  const calculateCommission = (amount) => {
    return toFloatWithoutRounding((amount * 0.03 * 100) / 100, 2);
  };

  // Calculate total amount (recharged amount + commission)
  const calculateTotal = (amount) => {
    const commission = calculateCommission(amount);
    return toFloatWithoutRounding(amount + commission, 2);
  };

  // Get current recharge amount
