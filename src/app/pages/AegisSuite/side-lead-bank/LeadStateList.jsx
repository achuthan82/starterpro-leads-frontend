...
const LeadStateList = ({ selectedStates = [], onViewLeads, pricingData, options, selectedAgency }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const res = await axios.get(
          `/starter-data/completed-incomplete-for-sale-total-count/paginated/${selectedAgency?.value}`,
          {
            params,
    ...
    fetchData();
  }, [selectedStates, page, perPage, selectedAgency]);
