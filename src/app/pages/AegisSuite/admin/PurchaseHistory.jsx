    ...
    <div className="flex h-screen bg-[var(--color-ecru-white)]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-auto p-6">
          ...
          {/* Filters */}
          <Card className="p-6 mb-6 bg-white shieldnest-shadow">
          ...
          {loading ? (
            ...
            <>
              ...
              <Card className="overflow-hidden bg-white shieldnest-shadow">
                {/* Table Header with Download Button */}
                <div className="px-6 py-4 border-b border-gray-200 bg-white">
                  <div className="flex items-center justify-between">
                    <div className='flex items-center'>
                    <h3 className="text-lg font-medium text-gray-900 mr-5">Purchase History</h3>
                      ...
                      {purchases.length === 0 ? (
                        <tr>
                          <td colSpan={isMarketPlace ? "6" : "5"} className="px-6 py-12 text-center">
                            <div className="text-gray-500">
                              ...
                              <p className="mt-1 text-sm text-gray-500">No purchase history available for the selected filters.</p>
                            </div>
                          </td>
                        </tr>
                      ) : (
                        purchases.map((purchase) => (
                          <React.Fragment key={purchase.id}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-900 font-mono">{purchase.id}</div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          {isMarketPlace && expandedRows.has(purchase.id) && purchase.invoice_data && purchase.invoice_data.items && (
                            <tr>
                              <td colSpan={isMarketPlace ? "6" : "5"} className="px-6 py-4 bg-gray-50">
