  ...
  return (
    <Card className="p-6 flex flex-col h-full shieldnest-white-column rounded-xl">
      <div className="flex justify-between items-center mb-4">
        <span className="text-lg font-bold text-[#0a2463]">{stateName}</span>
        <span className="bg-gray-100 text-gray-600 rounded-full px-3 py-1 text-sm font-semibold">{stateCode}</span>
      </div>
      {/* Pricing info */}
      ...
      <div className="flex gap-4 text-xs mt-2 mb-2">
      ...
      <div className="flex justify-between items-center mt-auto pt-2">
        <span className="text-gray-700 font-medium">{completed + incomplete} Total Leads</span>
