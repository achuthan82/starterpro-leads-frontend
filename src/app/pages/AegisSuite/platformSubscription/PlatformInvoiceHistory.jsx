            ...
            <div className="p-6 bg-white shieldnest-shadow overflow-hidden rounded-xl dark:bg-gray-800">
                <div className="flex justify-between items-center mb-4 px-5">
                    ...
                    <div className="flex items-center gap-2 text-blue-600 dark:text-gray-100">
                        <Button variant="solid" onClick={download} data-testid="btn-download-all" disabled={!pagination || pagination?.total < 1 || loading}>{!loading ? 'Download All' : <Spinner/> }</Button>
                    </div>
                </div>
                            ...
                            <Tr key={invoice.id}>
                                ...
                                <Td className='flex justify-center'>
                                    <div className="flex items-center gap-1 text-blue-600">
                                        <Button variant="link" size="sm" data-testid="btn-view" onClick={() => {navigate(`/platform-subscriptions/invoice/${invoice.id}?from=0`)}}>View</Button>
                                    </div>
                                </Td>
                            </Tr>
                        ))}
